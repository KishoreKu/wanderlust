                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-lg text-gray-700 mb-8">
                                Welcome to TravelHub. By accessing or using our website, you agree to be bound by these Terms of Service.
                            ...
                            <div className="mb-10">
                                ...
                                <p className="text-gray-700">
                                    By accessing and using TravelHub ("the Website"), you accept and agree to be bound by the terms and
                            ...
                            <div className="mb-10">
                                ...
                                <div className="ml-9 text-gray-700 space-y-4">
                                    <p>
                                        The Website and its original content, features, and functionality are owned by TravelHub and are
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            on this Website are the property of TravelHub or its content suppliers.
                                        </p>
                                    </div>
                            ...
                            <div className="mb-10">
                                ...
                                <div className="text-gray-700 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            The inclusion of any link does not imply endorsement by TravelHub. We have no control over the
                            ...
                            <div className="mb-10">
                                ...
                                <p className="text-gray-700">
                                    You agree to indemnify, defend, and hold harmless TravelHub and its officers, directors, employees,
                            ...
                            <div className="mb-10">
                                ...
                                <p className="text-gray-700">
                                    ...
                                    which TravelHub operates, without regard to its conflict of law provisions.
                                </p>
                            </div>
