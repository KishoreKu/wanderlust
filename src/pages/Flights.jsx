...
export function Flights() {
  const handleSearch = () => {
    window.open('https://gubbu-api.proudwater-f3417084.eastus2.azurecontainerapps.io/go/flights?src=web_flights', '_blank');
  };
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
            {popularRoutes.map((route, index) => (
              <button
                key={index}
                onClick={() => window.open('https://gubbu-api.proudwater-f3417084.eastus2.azurecontainerapps.io/go/flights?src=web_flights_popular', '_blank')}
          ...
          <div className="text-center">
            <Button size="lg" onClick={() => window.open('https://gubbu-api.proudwater-f3417084.eastus2.azurecontainerapps.io/go/flights?src=web_flights_popular', '_blank')}>
              🔵 Search Flights
            </Button>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Button size="lg" onClick={() => window.open('https://gubbu-api.proudwater-f3417084.eastus2.azurecontainerapps.io/go/flights?src=web_flights_cta', '_blank')} className="bg-primary-600 hover:bg-primary-700">
              🔵 Search Flights Now
            </Button>
          </div>
