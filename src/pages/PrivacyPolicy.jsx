                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-lg text-gray-700 mb-8">
                                At TravelHub, we take your privacy seriously. This Privacy Policy explains how we collect,
                            ...
                            <div className="mb-10">
                                ...
                                <div className="ml-9 text-gray-700">
                                    ...
                                    <p className="mt-3">
                                        To exercise these rights, please contact us at contact@travelhub.com.
                                    </p>
                                </div>
                            </div>
