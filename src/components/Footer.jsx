        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.pinterest.com/kishorealaj/" target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition-colors" aria-label="Pinterest">
