        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://bsky.app/profile/gubbu.bsky.social" target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition-colors" aria-label="Bluesky">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
